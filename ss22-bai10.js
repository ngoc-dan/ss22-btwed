...
while (choice !== 6) {
    ...
    switch (choice) {
        ...
        case 4:
            ...
            break;
        case 5:
            let deleteIndex = +prompt("mời bạn nhập vào vị trí phần tử muốn xóa ")
            let deleteElement = +prompt("mời bạn nhập vào số lượng pt muốn xóa ")
            arr.splice(deleteElement-1, deleteElement)
            break
        case 6:
            break;
    }
